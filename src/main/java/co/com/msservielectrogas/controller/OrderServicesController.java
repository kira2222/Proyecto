...
import co.com.msservielectrogas.services.IOrderServiceService;
...
public class OrderServicesController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<ApiResponseDTO<OrderServiceDTO>> getOrderServiceById(@PathVariable Long id) {
	    OrderServiceDTO orderServiceDTO = orderServiceService.getOrderServiceById(id);
	    if (orderServiceDTO != null) {
	        ApiResponseDTO<OrderServiceDTO> response = new ApiResponseDTO<>("Success", HttpStatus.OK.value(), orderServiceDTO);
	        return new ResponseEntity<>(response, HttpStatus.OK);
	    } else {
	        ApiResponseDTO<OrderServiceDTO> response = new ApiResponseDTO<>("Orden de servicio no encontrada", HttpStatus.NOT_FOUND.value(), null);
